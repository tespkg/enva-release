...
// Options defines the set of options supported by Meera's component logging package.
type Options struct {
...
//
// Cobra is the command-line processor that Meera uses. This command attaches
